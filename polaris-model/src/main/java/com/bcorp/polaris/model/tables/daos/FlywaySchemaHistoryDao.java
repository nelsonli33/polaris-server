...
import com.bcorp.polaris.model.tables.records.FlywaySchemaHistoryRecord;
...
@Repository
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory.class, configuration);
    }

    @Override
    public Integer getId(com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory object) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledRank(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     * Fetch a unique record that has <code>installed_rank = value</code>
     */
    public Optional<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchOptionalByInstalledRank(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfVersion(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfScript(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfChecksum(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledBy(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledOn(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfExecutionTime(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchRangeOfSuccess(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<com.bcorp.polaris.model.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Byte... values) {
