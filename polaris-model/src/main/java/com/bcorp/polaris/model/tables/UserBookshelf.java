...
public class UserBookshelf extends TableImpl<UserBookshelfRecord> {
     ...
     */
    public final TableField<UserBookshelfRecord, ULong> ID = createField(DSL.name("id"), SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>polaris-db.user_bookshelf.user_id</code>. 使用者 id
     */
    public final TableField<UserBookshelfRecord, ULong> USER_ID = createField(DSL.name("user_id"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "使用者 id");

    /**
     * The column <code>polaris-db.user_bookshelf.book_id</code>. 書本 id
     */
    public final TableField<UserBookshelfRecord, ULong> BOOK_ID = createField(DSL.name("book_id"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "書本 id");

    /**
     * The column <code>polaris-db.user_bookshelf.last_chapter_id</code>. 上次閱讀章節
     * id
     */
    public final TableField<UserBookshelfRecord, ULong> LAST_CHAPTER_ID = createField(DSL.name("last_chapter_id"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "上次閱讀章節 id");

    /**
     * The column <code>polaris-db.user_bookshelf.is_deleted</code>.
     * 是否刪除，0-未刪除，1-刪除，預設為 0
     */
    public final TableField<UserBookshelfRecord, UByte> IS_DELETED = createField(DSL.name("is_deleted"), SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINTUNSIGNED)), this, "是否刪除，0-未刪除，1-刪除，預設為 0");
    ...
    @Override
    public Identity<UserBookshelfRecord, ULong> getIdentity() {
        return (Identity<UserBookshelfRecord, ULong>) super.getIdentity();
    }
    ...
    @Override
    public Row7<ULong, ULong, ULong, ULong, UByte, LocalDateTime, LocalDateTime> fieldsRow() {
