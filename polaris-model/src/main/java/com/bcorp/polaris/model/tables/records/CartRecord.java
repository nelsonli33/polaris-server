...
public class CartRecord extends UpdatableRecordImpl<CartRecord> implements Record8<ULong, String, BigDecimal, BigDecimal, BigDecimal, ULong, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row8<ULong, String, BigDecimal, BigDecimal, BigDecimal, ULong, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public CartRecord value6(ULong value) {
        setUserId(value);
        return this;
    }
    ...
    @Override
    public CartRecord values(ULong value1, String value2, BigDecimal value3, BigDecimal value4, BigDecimal value5, ULong value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CartRecord(ULong id, String code, BigDecimal subtotal, BigDecimal totalPrice, BigDecimal totalDiscounts, ULong userId, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Cart.CART);
