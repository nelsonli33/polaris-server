...
public class PageRecord extends UpdatableRecordImpl<PageRecord> implements Record9<ULong, ULong, String, String, Integer, Integer, UByte, LocalDateTime, LocalDateTime> {
     ...
     */
    public void setChapterId(ULong value) {
        set(1, value);
    }
    ...
    @Override
    public Row9<ULong, ULong, String, String, Integer, Integer, UByte, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public PageRecord value1(ULong value) {
        setId(value);
        return this;
    }

    @Override
    public PageRecord value2(ULong value) {
        setChapterId(value);
        return this;
    }
    ...
    @Override
    public PageRecord value7(UByte value) {
        setIsDeleted(value);
        return this;
    }
    ...
    @Override
    public PageRecord values(ULong value1, ULong value2, String value3, String value4, Integer value5, Integer value6, UByte value7, LocalDateTime value8, LocalDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PageRecord(ULong id, ULong chapterId, String title, String body, Integer characterCount, Integer sortPosition, UByte isDeleted, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Page.PAGE);
