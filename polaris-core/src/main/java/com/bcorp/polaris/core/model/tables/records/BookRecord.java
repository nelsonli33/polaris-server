...
public class BookRecord extends UpdatableRecordImpl<BookRecord> implements Record15<ULong, ULong, ULong, String, UByte, BigDecimal, String, String, String, LocalDateTime, UByte, Integer, UByte, LocalDateTime, LocalDateTime>
{
     ...
     */
    public void setBookCategoryId(ULong value)
    {
        set(2, value);
    }
     ...
     * 2-付費，預設為 2
     */
    public void setPriceType(UByte value)
    {
        set(4, value);
    }
    ...
    @Override
    public Row15<ULong, ULong, ULong, String, UByte, BigDecimal, String, String, String, LocalDateTime, UByte, Integer, UByte, LocalDateTime, LocalDateTime> valuesRow()
    {
    ...
    {
        return Book.BOOK.BOOK_CATEGORY_ID;
    }
    ...
    @Override
    public BookRecord value2(ULong value)
    {
        setUserId(value);
        return this;
    }
    ...
    @Override
    public BookRecord value5(UByte value)
    {
        setPriceType(value);
        return this;
    }
    ...
    @Override
    public BookRecord value11(UByte value)
    {
        setStatus(value);
        return this;
    }
    ...
    @Override
    public BookRecord value13(UByte value)
    {
        setIsDeleted(value);
        return this;
    }
    ...
    @Override
    public BookRecord values(ULong value1, ULong value2, ULong value3, String value4, UByte value5, BigDecimal value6, String value7, String value8, String value9, LocalDateTime value10, UByte value11, Integer value12, UByte value13, LocalDateTime value14, LocalDateTime value15)
    {
        value1(value1);
        value2(value2);
        value3(value3);
     ...
     */
    public BookRecord(ULong id, ULong userId, ULong bookCategoryId, String title, UByte priceType, BigDecimal price, String synopsis, String acquisition, String cover, LocalDateTime publishedAt, UByte status, Integer characterCount, UByte isDeleted, LocalDateTime createdAt, LocalDateTime updatedAt)
    {
        super(Book.BOOK);
