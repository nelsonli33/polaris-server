...
public class OrderLineItemRecord extends UpdatableRecordImpl<OrderLineItemRecord> implements Record11<Long, Long, Long, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal, Byte, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row11<Long, Long, Long, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal, Byte, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public OrderLineItemRecord value9(Byte value) {
        setIsDeleted(value);
        return this;
    }

    @Override
    public OrderLineItemRecord value10(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }
    ...
    @Override
    public OrderLineItemRecord values(Long value1, Long value2, Long value3, String value4, BigDecimal value5, BigDecimal value6, BigDecimal value7, BigDecimal value8, Byte value9, LocalDateTime value10, LocalDateTime value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrderLineItemRecord(Long id, Long orderId, Long bookId, String name, BigDecimal price, BigDecimal subtotal, BigDecimal totalDiscounts, BigDecimal totalPrice, Byte isDeleted, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(OrderLineItem.ORDER_LINE_ITEM);
