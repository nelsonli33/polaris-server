...
public class OrderLineItemRecord extends UpdatableRecordImpl<OrderLineItemRecord> implements Record12<Long, Long, Long, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal, String, Byte, LocalDateTime, LocalDateTime> {
    ...
    /**
     * Setter for <code>polaris-db.order_line_item.item_status</code>.
     */
    ...
    /**
     * Getter for <code>polaris-db.order_line_item.item_status</code>.
     */
    ...
    @Override
    public Row12<Long, Long, Long, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal, String, Byte, LocalDateTime, LocalDateTime> fieldsRow() {
        return (Row12) super.fieldsRow();
    }

    @Override
    public Row12<Long, Long, Long, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal, String, Byte, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    public Field<String> field9() {
        return OrderLineItem.ORDER_LINE_ITEM.ITEM_STATUS;
    }
    ...
    @Override
    public OrderLineItemRecord value6(BigDecimal value) {
        setSubtotal(value);
        return this;
    }
    ...
    @Override
    public OrderLineItemRecord value9(String value) {
        setItemStatus(value);
        return this;
    }
    ...
    @Override
    public OrderLineItemRecord values(Long value1, Long value2, Long value3, String value4, BigDecimal value5, BigDecimal value6, BigDecimal value7, BigDecimal value8, String value9, Byte value10, LocalDateTime value11, LocalDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrderLineItemRecord(Long id, Long orderId, Long bookId, String name, BigDecimal price, BigDecimal subtotal, BigDecimal totalDiscounts, BigDecimal totalPrice, String itemStatus, Byte isDeleted, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(OrderLineItem.ORDER_LINE_ITEM);
