...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, Byte> IS_AUTHOR = createField(DSL.name("is_author"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)), this, "是否是作者，0-否，1-是，預設為 0");
     ...
     */
    public final TableField<UserRecord, Byte> IS_DELETED = createField(DSL.name("is_deleted"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)), this, "是否刪除，0-未刪除，1-刪除，預設為 0");
