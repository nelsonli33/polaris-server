...
public class PaymentMode extends TableImpl<PaymentModeRecord> {
     ...
     */
    public final TableField<PaymentModeRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<PaymentModeRecord, Byte> IS_ACTIVE = createField(DSL.name("is_active"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("1", SQLDataType.TINYINT)), this, "是否啟用，0-未啟用，1-啟用，預設為 1");

    /**
     * The column <code>polaris-db.payment_mode.is_deleted</code>.
     * 是否刪除，0-未刪除，1-刪除，預設為 0
     */
    public final TableField<PaymentModeRecord, Byte> IS_DELETED = createField(DSL.name("is_deleted"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)), this, "是否刪除，0-未刪除，1-刪除，預設為 0");
    ...
    @Override
    public Identity<PaymentModeRecord, Long> getIdentity() {
        return (Identity<PaymentModeRecord, Long>) super.getIdentity();
    }
