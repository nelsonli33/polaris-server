...
public class BookReview extends TableImpl<BookReviewRecord> {
     ...
     */
    public final TableField<BookReviewRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<BookReviewRecord, Byte> RATING_STAR = createField(DSL.name("rating_star"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)), this, "評分 0 ~ 5");

    /**
     * The column <code>polaris-db.book_review.is_deleted</code>.
     * 是否刪除，0-未刪除，1-刪除，預設為 0
     */
    public final TableField<BookReviewRecord, Byte> IS_DELETED = createField(DSL.name("is_deleted"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)), this, "是否刪除，0-未刪除，1-刪除，預設為 0");
    ...
    @Override
    public Identity<BookReviewRecord, Long> getIdentity() {
        return (Identity<BookReviewRecord, Long>) super.getIdentity();
    }
