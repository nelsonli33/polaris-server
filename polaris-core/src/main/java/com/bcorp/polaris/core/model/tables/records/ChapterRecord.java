...
public class ChapterRecord extends UpdatableRecordImpl<ChapterRecord> implements Record7<Long, Long, String, Integer, Byte, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row7<Long, Long, String, Integer, Byte, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public ChapterRecord values(Long value1, Long value2, String value3, Integer value4, Byte value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ChapterRecord(Long id, Long bookId, String title, Integer sortPosition, Byte isDeleted, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Chapter.CHAPTER);
