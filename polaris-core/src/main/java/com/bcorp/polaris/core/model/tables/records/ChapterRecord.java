...
public class ChapterRecord extends UpdatableRecordImpl<ChapterRecord> implements Record7<Long, Long, String, String, Byte, LocalDateTime, LocalDateTime> {
    ...
    /**
     * Setter for <code>polaris-db.chapter.rank</code>. 排序位置 (alphaNumeric)
     */
    ...
    /**
     * Getter for <code>polaris-db.chapter.rank</code>. 排序位置 (alphaNumeric)
     */
    ...
    @Override
    public Row7<Long, Long, String, String, Byte, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public ChapterRecord value2(Long value) {
        setBookId(value);
        return this;
    }
    ...
    @Override
    public ChapterRecord value4(String value) {
        setRank(value);
        return this;
    }

    @Override
    public ChapterRecord value5(Byte value) {
        setIsDeleted(value);
        return this;
    }
    ...
    @Override
    public ChapterRecord values(Long value1, Long value2, String value3, String value4, Byte value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ChapterRecord(Long id, Long bookId, String title, String rank, Byte isDeleted, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Chapter.CHAPTER);
