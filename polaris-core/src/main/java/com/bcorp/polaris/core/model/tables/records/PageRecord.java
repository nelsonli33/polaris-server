...
public class PageRecord extends UpdatableRecordImpl<PageRecord> implements Record12<Long, Long, Long, Long, String, String, JSON, Integer, String, Byte, LocalDateTime, LocalDateTime> {
    ...
    /**
     * Setter for <code>polaris-db.page.description</code>. 頁面標題
     */
    ...
    /**
     * Getter for <code>polaris-db.page.description</code>. 頁面標題
     */
    ...
    /**
     * Setter for <code>polaris-db.page.body</code>. 頁面內容 (json)
     */
    ...
    /**
     * Getter for <code>polaris-db.page.body</code>. 頁面內容 (json)
     */
    public JSON getBody() {
        return (JSON) get(6);
    }
    ...
    /**
     * Setter for <code>polaris-db.page.rank</code>. 排序位置 (alphaNumeric)
     */
    ...
    /**
     * Getter for <code>polaris-db.page.rank</code>. 排序位置 (alphaNumeric)
     */
    ...
    @Override
    public Row12<Long, Long, Long, Long, String, String, JSON, Integer, String, Byte, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public PageRecord value7(JSON value) {
        setBody(value);
        return this;
    }
    ...
    @Override
    public PageRecord value9(String value) {
        setRank(value);
        return this;
    }

    @Override
    public PageRecord value10(Byte value) {
        setIsDeleted(value);
        return this;
    }
    ...
    @Override
    public PageRecord value12(LocalDateTime value) {
        setUpdatedAt(value);
        return this;
    }

    @Override
    public PageRecord values(Long value1, Long value2, Long value3, Long value4, String value5, String value6, JSON value7, Integer value8, String value9, Byte value10, LocalDateTime value11, LocalDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PageRecord(Long id, Long chapterId, Long bookId, Long userId, String title, String description, JSON body, Integer characterCount, String rank, Byte isDeleted, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Page.PAGE);
