...
public class PageRecord extends UpdatableRecordImpl<PageRecord> implements Record12<Long, Long, Long, Long, String, String, JSON, Integer, Integer, Byte, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row12<Long, Long, Long, Long, String, String, JSON, Integer, Integer, Byte, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public PageRecord values(Long value1, Long value2, Long value3, Long value4, String value5, String value6, JSON value7, Integer value8, Integer value9, Byte value10, LocalDateTime value11, LocalDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PageRecord(Long id, Long chapterId, Long bookId, Long userId, String title, String description, JSON body, Integer characterCount, Integer sortPosition, Byte isDeleted, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Page.PAGE);
