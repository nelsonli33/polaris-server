...
(
    ...
    `subtitle`        VARCHAR(255)        NOT NULL DEFAULT '' COMMENT '書本副標題',
    ...
    `synopsis`        TEXT                NULL COMMENT '書本簡介',
    ...
    `is_deleted`      TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否刪除，0-未刪除，1-刪除，預設為 0',
...
(
    ...
    `rank`       VARCHAR(255)        NOT NULL DEFAULT '' COMMENT '排序位置 (alphaNumeric)',
    `is_visible` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否顯示前台，0-否，1-是，預設為 0',
    `is_deleted` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否刪除，0-未刪除，1-刪除，預設為 0',
    `created_at` DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
    `updated_at` DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改時間',
    PRIMARY KEY (id)
...
(
    ...
    `is_author`            TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否是作者，0-否，1-是，預設為 0',
    ...
    `is_blocked`           TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否停權，0-否，1-是，預設為 0',
    `is_deleted`           TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否刪除，0-未刪除，1-刪除，預設為 0',
    `created_at`           DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
    `updated_at`           DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改時間',
    PRIMARY KEY (id),
...
(
    ...
    `is_deleted`      TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '訂單禁止刪除',
    `created_at`      DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
    `updated_at`      DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改時間',
    PRIMARY KEY (id),
...
(
    ...
    `is_deleted`      TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '訂單商品禁止刪除',
    `created_at`      DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
    `updated_at`      DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改時間',
    PRIMARY KEY (id)
);
...
(
    ...
    `is_deleted`      TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '訂單發票禁止刪除',
    `created_at`      DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
    `updated_at`      DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改時間',
    PRIMARY KEY (id)
);
