...
{
    public static final Logger log = LogManager.getLogger(EcpayPaymentClient.class);

    private String operatingMode;
    private String isProjectContractor;
    private String HashKey;
    private String HashIV;
    private String MerchantID;
    private String PlatformID;
    private String aioCheckOutUrl;
    private String doActionUrl;
    private String queryCreditTradeUrl;
    private String queryTradeInfoUrl;
    private String queryTradeUrl;
    private String tradeNoAioUrl;
    private String fundingReconDetailUrl;
    private String createServerOrderUrl;
    private String[] ignorePayment;

    private EcpayPaymentClient(String operatingMode, String isProjectContractor,
                               String hashKey, String hashIV, String merchantID,
                               String PlatformID, String[] ignorePayment)
    {
    ...
    public static EcpayPaymentClientBuilder builder()
    {
        return new EcpayPaymentClientBuilder();
    }

    public static class EcpayPaymentClientBuilder
    {
        private String operatingMode;
        ...
        public EcpayPaymentClientBuilder operatingMode(OperatingMode operatingMode)
        {
        ...
        public EcpayPaymentClientBuilder isProjectContractor(String isProjectContractor)
        {
            this.isProjectContractor = isProjectContractor;
            return this;
        }

        public EcpayPaymentClientBuilder HashKey(String HashKey)
        {
            this.HashKey = HashKey;
            return this;
        }

        public EcpayPaymentClientBuilder HashIV(String HashIV)
        {
            this.HashIV = HashIV;
            return this;
        }

        public EcpayPaymentClientBuilder MerchantID(String MerchantID)
        {
            this.MerchantID = MerchantID;
            return this;
        }

        public EcpayPaymentClientBuilder PlatformID(String PlatformID)
        {
            this.PlatformID = PlatformID;
            return this;
        }

        public EcpayPaymentClientBuilder ignorePayment(String[] ignorePayment)
        {
            this.ignorePayment = ignorePayment;
            return this;
        }

        public EcpayPaymentClient build()
        {
            if (HashKey == null)
            {
            ...
            return new EcpayPaymentClient(operatingMode, isProjectContractor,
                    HashKey, HashIV, MerchantID, PlatformID, ignorePayment);
        }
    }
}
