...
import ecpay.payment.integration.OperatingMode;
...
{
    private static EcpayPaymentClient client = EcpayPaymentClient.builder()
...
//		System.out.println("aioCheckOutWebATM: " + genAioCheckOutWebATM());
    ...
    public static String postCreateServerOrder()
    {
        ...
        return client.createServerOrder(obj);
    }
    ...
    public static String postFundingReconDetail()
    {
        ...
        return client.fundingReconDetail(obj);
    }
    ...
    public static String postQueryTradeInfo()
    {
        ...
        return client.queryTradeInfo(obj);
    }
    ...
    public static String postQueryCreditCardPeriodInfo()
    {
        ...
        return client.queryCreditCardPeriodInfo(obj);
    }
    ...
    public static String genAioCheckOutWebATM()
    {
        ...
        String form = client.aioCheckOut(obj, null);
        return form;
    }
    ...
    public static String genAioCheckOutCVS()
    {
        ...
        String form = client.aioCheckOut(obj, invoice);
        return form;
    }
    ...
    public static String genAioCheckOutDevide()
    {
        ...
        obj.setReturnURL("http://211.23.128.214:5000");
        obj.setNeedExtraPaidInfo("N");
//        obj.setCreditInstclientment("3,6");
//        obj.setInstclientmentAmount("10");
        String form = client.aioCheckOut(obj, null);
        return form;
    }
